...
/**
 * 给定两个已排序的表L1和L2，只使用基本的表操作编写计算L1 交 L2的过程
 *
 * 计算逻辑：
...
public class ChapterThreeQuestionFour {
     ...
     * @return 两表的交集结果
     */
    public static <T extends Comparable<? super T>> List<T> intersection(List<T> l1, List<T> l2) {
     ...
     * @param <T>
     */
    public static <T extends Comparable<? super T>> void intersection2(List<T> l1, List<T> l2, List<T> result) {
